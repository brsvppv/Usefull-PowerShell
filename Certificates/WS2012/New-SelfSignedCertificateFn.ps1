function New-SelfSignedCertificateFn {
    ...
    param (
        ...
        [string]$SignatureAlgorithm = "SHA2",
        [string]$FriendlyName,
...
$FriendlyName = 'TeamVISIONBulgaria.com'
...
New-SelfSignedCertificateFn -Subject “CN=$subject, O=$Organization, OU=$OrgUnit,E=$emailSettings,L=$Location, C=$Country" `
